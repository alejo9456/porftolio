...
export const Presentation = () => {
  ...
  return (
    <section id="home" className='flex flex-col items-center justify-center h-full py-24'>
        ...
        <a href="https://drive.google.com/file/d/1VNhdLJWWEcHctNCrczk_2nl5cAEds7wA/view?usp=drive_link" target="_blank" rel="noopener noreferrer" className="max-w-48 mb-10 bg-brightTurquoise bg opacity-90 hover:bg-opacity-80 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 me-2">
          Ver CV
        </a>
